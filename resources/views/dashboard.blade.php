    ...
    <div class="row justify-content-center">
        <div class="col-3 text-center m-auto">
            ...
            <form method="POST" action="{{route('registerProcess')}}">
                ...
                <label for="passwordInput">Подтверждение пароля</label>
                <input name="password_confirmation" class="form-control" type="password" id="passwordInput" placeholder="Подтверждение пароля">
                <div class="">
